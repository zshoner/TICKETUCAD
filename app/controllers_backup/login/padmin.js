...
async function cargarSelectsFormTicket() {
    try {
        const fetchOpts = { credentials: 'same-origin', headers: { 'X-Requested-With': 'XMLHttpRequest', 'Accept': 'application/json' } };
        const [resCat, resPrio] = await Promise.all([
            fetch('/TICKETUCAD/app/models/php/obtener_categorias.php', fetchOpts),
            fetch('/TICKETUCAD/app/models/php/obtener_prioridades.php', fetchOpts)
        ]);
...
async function cargarSesionUsuario() {
    try {
        const res  = await fetch('/TICKETUCAD/app/models/login/sesion.php', { credentials: 'same-origin', headers: { 'X-Requested-With': 'XMLHttpRequest', 'Accept': 'application/json' } });
...
const viewMap = {
    inicio:       '/TICKETUCAD/app/router/view.php?view=inicio',
    usuarios:     '/TICKETUCAD/app/router/view.php?view=usuarios',
    reportes:     '/TICKETUCAD/app/router/view.php?view=reportes',
    configuracion:'/TICKETUCAD/app/router/view.php?view=configuracion',
    tickets:      '/TICKETUCAD/app/router/view.php?view=tickets',
    form_user:    '/TICKETUCAD/app/router/view.php?view=form_user',
    dashboard:    '/TICKETUCAD/app/router/view.php?view=dashboard' // <-- NUEVO
};
